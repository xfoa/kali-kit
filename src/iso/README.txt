...
Kali is a program that tunnels IPX network traffic over TCP/IP, allowing old
games and applications that use IPX to connect over networks that only support
TCP/IP, including the internet.  This CD contains a collection of tools and
drivers to get Kali [https://kali.net] running on an MS-DOS PC, and guides on
how to set it up on real and emulated hardware. 

Quick start: run INSTALL.BAT to copy network drivers and Kali to your hard
drive.

The config files and scripts included here assume a Novell NE1000 network
adapter. Many more drivers are included on this CD for a large variety of
network adapters.
